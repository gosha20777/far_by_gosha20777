...
Based on [WinSCP](http://winscp.net/eng/index.php) version 5.7.6 Copyright (c) 2000-2015 Martin Prikryl  
SSH and SCP code based on PuTTY 0.66 Copyright (c) 1997-2015 Simon Tatham  
